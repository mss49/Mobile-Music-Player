...
public class MusicLibrary {
    ...
    private void loadArtists() {
        // Implementation to load artists
    }
    ...
    private void saveSongs() {
        // Implementation to save songs
    }
    
    private void saveArtists() {
        // Implementation to save artists
    }
    ...
    public int getNextPlaylistId() {
        return playlists.keySet().stream().mapToInt(Integer::intValue).max().orElse(0) + 1;
    }
